...
function Healthbar.draw(sprite_batch, x, y, health, max_health)
    ...
    local fg_width = math.max(Healthbar.WIDTH * health_bar_filled_percentage - DOUBLE_HEALTH_BAR_PADDING, 0)
    sprite_batch:add_sprite(SQUARE_SPRITE, x + HEALTH_BAR_PADDING, y + HEALTH_BAR_PADDING, 0, 0,
        fg_width, HEALTH_BAR_HEIGHT - DOUBLE_HEALTH_BAR_PADDING, 0, 0)
