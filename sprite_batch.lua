...
function SpriteBatch:add_sprite(sprite, x, y, z, r, scale_x, scale_y, origin_x, origin_y)
    ...
    self.batch:add(sprite.quad, math.floor(x), math.floor(y - z), r or 0, scale_x or 1, scale_y or 1, origin_x, origin_y)
end
...
function SpriteBatch:add_shadow(sprite, x, y, z, r, scale_x, scale_y, origin_x, origin_y)
    scale_x = scale_x or 1
    scale_y = scale_y or 1
    origin_x = origin_x or sprite.width * 0.5
    origin_y = origin_y or sprite.height * 0.5

    local offset_x = math.floor(sprite.width * 0.15)
    local offset_y = math.floor(sprite.height * 0.8)
